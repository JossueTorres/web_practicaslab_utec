                                                    ...
                                                    foreach ($lst1 as $lb) { ?>
                                                        <tr>
                                                            ...
                                                            <td style="text-align:center; ">
                                                             <button class="btn btn-sm btn-info btn-xs boton_ver_maq" nombre="<?php echo $lb->lab_nombre; ?>" codigo="<?php echo $lb->lab_codigo; ?>" type="button"><span class="fa fa-laptop btn-xs"></span></button>
