                                                    ...
                                                    foreach ($lst1 as $lb) { ?>
                                                        <tr>
                                                            ...
                                                            <td style="text-align:center; ">
                                                             <button class="btn btn-sm btn-info btn-xs boton_ver_maq" title="Administrar Laboratorio" nombre="<?php echo $lb->lab_nombre; ?>" codigo="<?php echo $lb->lab_codigo; ?>" type="button"><span class="fa fa-laptop btn-xs"></span></button>
...
<form id='frm_maquinasLab' class="hidden" name="frm_maquinasLab" action="<?php echo base_url('Admin/Laboratorio/Maquinas'); ?>" method="POST">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(".boton_ver_maq").click(function(){
            $("#lblcodlab").val( $(this).attr("codigo"));
            $("#lblnomlab").val( $(this).attr("nombre"));
            $("#btnMostrarMaq").click();
        });
    });
</script>